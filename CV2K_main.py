...
if __name__ == '__main__':
    ...
    if not os.path.exists(run_dir):
        os.makedirs(run_dir)
    # save scripts
    os.system('cp CV2K_main.py ' + run_dir + '/' + 'CV2K_main.py.backup')
    os.system('cp CV2K_cv.py ' + run_dir + '/' + 'CV2K_cv.py.backup')
    ...
    # plot the results
    CV2K_plot.plot(run_dir, data, ranks=rank_cyc, args=vars(args))
